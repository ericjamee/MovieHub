    ...
    >
      ...
      <div
        ...
        style={{
          position: "relative",
          backgroundImage:
            "url(https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bW92aWUlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fHww)",
      ...
      >
        ...
        >
          ...
          <p className="mb-5">
            Ready to watch? Sign up to create your membership.
          </p>
                ...
                <Card.Body className="p-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Good video
                      quality
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Watch on your
                      laptop and TV
                    </li>
                    <li className="mb-3 d-flex align-items-center">
            ...
            <Col md={4}>
              ...
              >
                ...
                <Card.Body className="p-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Full HD
                      available
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Watch on any
                      device
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Downloads
                      available
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Cancel anytime
            ...
            <Col md={4}>
              <Card className="bg-dark text-white h-100 border-0 shadow-sm">
                ...
                <Card.Body className="p-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Ultra HD
                      available
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Watch on any
                    ...
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Exclusive
                      content
                    </li>
                    <li className="mb-3 d-flex align-items-center">
                      <FaCheck className="text-success me-2" /> Cancel anytime
        ...
        <Container className="py-3">
          ...
          >
            <div className="accordion-item bg-dark text-white border-0 mb-3">
              ...
              >
                <div className="accordion-body">
                  Cine is a streaming service that offers a wide variety of
            ...
            <div className="accordion-item bg-dark text-white border-0 mb-3">
              ...
              >
                <div className="accordion-body">
                  Watch Cine on your smartphone, tablet, Smart TV, laptop, or
            ...
            <div className="accordion-item bg-dark text-white border-0 mb-3">
              ...
              >
                <div className="accordion-body">
                  Watch anywhere, anytime. Sign in with your CineNiche account
                  to watch instantly on the web at cineNiche.com from your
                  personal computer or on any internet-connected device that
                  offers the CineNiche app, including smart TVs, smartphones,
